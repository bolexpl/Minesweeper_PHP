...
?>
  ...
  <section class="index">
    <form method="post" action="board.php" onsubmit="return start();">
      ...
      <div id="custom" class="grey" >
        <div class="form-group">
          ...
          <input type="text" name="width" class="form-control" title="Szerokość" id="width" placeholder="Szerokość" disabled>
        </div>
        <div class="form-group">
          <label for="height">Wysokość</label>
          <input type="text" name="height" class="form-control" title="Wysokość" id="height" placeholder="Wysokość" disabled>
        </div>
        <div class="form-group">
          <label for="mines">Liczba min</label>
          <input type="text" name="mines" class="form-control" title="Liczba min" id="mines" placeholder="Liczba min" disabled>
        </div>
      </div>
